    ...
    <div className="mx-auto flex min-h-screen max-w-7xl flex-1 flex-col items-center justify-center gap-16 px-4 py-20">
      <div className="flex max-w-3xl flex-col items-center gap-4">
        <h1 className="text-center text-7xl/none font-medium tracking-tight">
          ...
          <Link
            href="#case"
            className="relative whitespace-nowrap text-muted-foreground transition hover:text-primary"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="fill-/70 absolute left-0 top-2/3 h-[0.58em] w-full"
            ...
            <span className="relative">een pro,</span>
          </Link>{" "}
          in 3 minuten.
        </h1>
        <p className="max-w-xl text-center leading-tight tracking-tight">
